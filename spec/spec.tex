...
language-oriented programming. It provides both the means to express intention in terms
of domain-specific languages and a way to extend C with new programming language constructs,
leading to a clearer and safer design of APIs. One example is typext4c \cite{typext4c}, a
header-only library implementing various type system extensions.
