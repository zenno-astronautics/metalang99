...
language-oriented programming. With Macrolop, developers express their intention in terms
of domain-specific languages provided as ordinary C libraries. One example is typext4c
\cite{typext4c}, a header-only library implementing various type system extensions for
pure C.
