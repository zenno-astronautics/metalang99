...
language-oriented programming. The idea is to solve problems in terms of concise
domain-specific languages represented as software building blocks, leading to a clearer and safer
design of APIs. Domain-specific languages built upon Macrolop range from purely utilitary,
such as a unit testing framework, to foreign programming language constructs, such as algebraic
data types and software interfaces \cite{typext4c}.

The two main characteristics of this project are:
