...
#define MACROLOP_PRIVATE_EVAL_ARGS_SAVE_CALL_RES_HOOK() MACROLOP_PRIVATE_EVAL_ARGS_SAVE_CALL_RES
...
#define MACROLOP_PRIVATE_EVAL_ARGS_AUX_CALL(k, k_cx, acc, tail, op, ...)                           \
    MACROLOP_PRIVATE_EVAL_REC_CONTINUE(                                                            \
        ...
        (MACROLOP_PRIVATE_EVAL_ARGS_SAVE_CALL_RES_HOOK, (k, k_cx, acc, tail)),                     \
        call(op, __VA_ARGS__))

#define MACROLOP_PRIVATE_EVAL_ARGS_SAVE_CALL_RES MACROLOP_PRIVATE_EVAL_ARGS_AUX_v
