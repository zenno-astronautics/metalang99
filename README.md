...
Epilepsy is a tool for [language-oriented programming]: you _reflect_ the real world conditions in terms of [domain-specific languages] which are best suited for your tasks, leading to more a expressive and reliable design.
