...
Epilepsy is a tool for [language-oriented programming] (C99/C++11 onwards): you `#define` [DSL]s whose syntax reflects your problem domain, leading to more expressive and reliable code.
