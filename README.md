...
Macrolop is an embedded [metalanguage] that facilitates [language-oriented programming] in plain C -- express your intention in terms of your own declarative [domain-specific languages]. Macrolop accomplishes its goal by extending the standard preprocessor with high-level programming constructs to let us deal with [metaprogramming] on a large scale.
