...
Epilepsy is a functional programming language that executes on any C99/C++11-compliant preprocessor. It enriches the standard preprocessor with basic and compound data types, control expressions, collections, and other stuff, thereby serving as a framework for metaprogramming.
