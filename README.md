...
In the first case, you must add one more include path `epilepsy/include`. To use Epilepsy, just `#include <epilepsy.h>` beforehand. No additional setup is needed: Epilepsy is implemented using only preprocessor macros.
