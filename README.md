...
To solve the problem, I have implemented a programming language atop the preprocessor, Epilepsy. Its goal is to make development of both small and complex metaprograms painless. For example, consider [datatype99] -- type-safe [algebraic data types] implemented with the aid of Epilepsy:
