...
A:
 ...
 - **Formal proofs.** With a mathematical model it becomes possible to proof things about Epilepsy formally; for example, the progress theorem which is already prooved.
