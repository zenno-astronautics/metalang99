...
Epilepsy is a tool for [language-oriented programming]: you _reflect_ the problem domain in terms of small languages which are best suited for your tasks rather than (ab)using overly redundant mechanisms of a general-purpose programming language, leading to more a expressive and reliable design.
