...
Epilepsy is a tool for [language-oriented programming]: you are encouraged to solve problems via small languages that _reflect_ your problem domain rather than using redundant mechanisms of a general-purpose programming language, leading to more expressive and reliable design.
