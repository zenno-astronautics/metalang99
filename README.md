<div align="center">
  ...
  Macros provide the means to abstract frequently occuring syntactical constructs in order to improve clearness of code, with all far-reaching consequences, such as enhanced readability, writability, and maintainability. What is more interesting is that a metaprogramming-amplified programming language is rather a building material because, in fact, the normal development procedure is to create [embedded domain-specific languages] and then express our intention in terms of them, rather than using overly liberal functionality from a host language.
